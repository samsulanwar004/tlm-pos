  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">User Administrator</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card card-secondary">
              <div class="card-header">
                <a href="{{ route('administrator.user.create') }}" class="btn btn-dark">
              ...
              <div class="card-body table-responsive">
                <div class="table large">
                  <x-datatable.table>
                    ...
                    <th data-data="role" class="font-weight-bold text-center text-uppercase">Role</th>
